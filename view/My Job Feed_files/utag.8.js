//tealium universal tag - utag.8 ut4.0.201512071640, Copyright 2015 Tealium.com Inc. All Rights Reserved.
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1};u.partnerid="30393";u.type="hp";u.base_url="//img.pulsemgr.com/script/pm/100/";u.map={"pty":"pty","aol_sku":"pid"};u.extend=[function(a,b,c,d,e,f,g){d=b['page_type'];if(typeof d=='undefined')return;c=[{'home':'hp'},{'category':'cp'},{'product':'pp'},{'checkout':'ct'},{'thankyou':'cfp'}];var m=false;for(e=0;e<c.length;e++){for(f in c[e]){if(d==f){b['pty']=c[e][f];m=true};};if(m)break};if(!m)b['pty']='';},function(a,b){if(b.page_type=="product"&b.product_sku){b.aol_sku=b.product_sku[0]}
else if(b.product_sku){b.aol_sku=b.product_sku}}];u.send=function(a,b){if(u.ev[a]||typeof u.ev.all!="undefined"){var c,d,e,f,g;c=[];g={};for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){}};for(d in utag.loader.GV(u.map)){if(typeof b[d]!="undefined"&&b[d]!=""){e=u.map[d].split(",");for(f=0;f<e.length;f++){if(e[f]=='pty'){u.type=b[d]}else if(e[f]=="pid"||e[f]=="cid"||e[f]=="partnerid"){u[e[f]]=b[d];}else{g[e[f]]=b[d];}}}}
u.adr_callback=function(){pulse.setPartnerId(u.partnerid);pulse.setSite(utag.loader.lh());pulse.set('prf',b['dom.referrer']);u.pid=u.pid||b._cprod||[];if(b.page_type&&b.page_type=="product"){u.pid=b._cprod[0]||[];}
u.cid=u.cid||b._ccat||[];if(b._corder){u.type="cfp";pulse.set('onm',b._corder);pulse.set('ovl',b._csubtotal);pulse.set('pce','1');}else{pulse.set('pce','0');}
